  ...
  <div className="header-bot">
    <div className="header-bot_inner_wthreeinfo_header_mid">
      ...
      <div className="col-md-4 logo_agile">
        <h1>
          <a href="index.html">
            <span>G</span>rocery
            <span>S</span>hoppy
            <img src="main/images/logo2.png" alt=" " />
          </a>
        </h1>
      </div>
      {/* header-bot */}
      <div className="col-md-8 header">
        ...
        <ul>
          <li>
            <Link to='/'><span className="fa fa-map-marker" aria-hidden="true" />Sản Phẩm</Link>
          </li>
          <li>
            <Link to="/about" >
              <span className="fa fa-truck" aria-hidden="true" />About</Link>
          </li>
          <li>
          <Link to="/blog" >
              <span className="fa fa-truck" aria-hidden="true" />Blog</Link>
          </li>
          <li>
          <Link to="/contact" >
              <span className="fa fa-truck" aria-hidden="true" />Contact</Link>
          </li>
          <li>
